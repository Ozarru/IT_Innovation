...
Revision ID: c4177015add0
Revises: e50604f927e1
Create Date: 2022-06-29 11:33:52.499880
...
revision = 'c4177015add0'
down_revision = 'e50604f927e1'
branch_labels = None
depends_on = None
...
def upgrade():
    ...
    op.add_column('grades', sa.Column('supervisor_mail', sa.String(), nullable=False))
