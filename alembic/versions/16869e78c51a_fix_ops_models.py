...
Revision ID: 16869e78c51a
Revises: a0f4e622acdb
Create Date: 2022-06-29 11:21:49.877714
...
revision = '16869e78c51a'
down_revision = 'a0f4e622acdb'
branch_labels = None
depends_on = None
...
def upgrade():
    ...
    op.create_table('terms',
                    ...
                    sa.ForeignKeyConstraint(
                        ['edu_phase_id'], ['edu_phases.id'], ondelete='CASCADE'),
                    sa.PrimaryKeyConstraint('id')
                    )
    op.create_table('fees',
                    sa.Column('id', sa.Integer(),
                              autoincrement=True, nullable=False),
                    sa.Column('academic_year_id',
                              sa.Integer(), nullable=False),
                    sa.Column('term_id', sa.Integer(), nullable=False),
                    sa.Column('grade_id', sa.Integer(), nullable=False),
                    sa.Column('amount', sa.Integer(), nullable=False),
                    sa.ForeignKeyConstraint(['academic_year_id'], [
                        'academic_years.id'], ondelete='CASCADE'),
                    sa.ForeignKeyConstraint(
                        ['grade_id'], ['grades.id'], ondelete='CASCADE'),
                    sa.ForeignKeyConstraint(
                        ['term_id'], ['terms.id'], ondelete='CASCADE'),
                    sa.PrimaryKeyConstraint('id')
                    )
    op.create_table('subjects',
                    ...
                    sa.Column('grade_id', sa.Integer(), nullable=False),
                    sa.Column('teacher_mail', sa.String(), nullable=False),
                    sa.Column('term_id', sa.Integer(), nullable=False),
                    sa.Column('academic_year_id',
                              sa.Integer(), nullable=False),
                    sa.ForeignKeyConstraint(['academic_year_id'], [
                    ...
                    sa.ForeignKeyConstraint(
                        ['grade_id'], ['grades.id'], ondelete='CASCADE'),
                    sa.ForeignKeyConstraint(
                        ['teacher_mail'], ['staff.email'], ondelete='CASCADE'),
                    sa.ForeignKeyConstraint(
                        ['term_id'], ['terms.id'], ondelete='CASCADE'),
                    sa.PrimaryKeyConstraint('id')
                    )
    ...
    op.create_table('class_attendance',
                    ...
                    sa.Column('date', sa.TIMESTAMP(timezone=True),
                              server_default=sa.text('now()'), nullable=True),
                    sa.ForeignKeyConstraint(['student_matric'], [
                        'students.matric_id'], ondelete='CASCADE'),
                    sa.ForeignKeyConstraint(
                        ['subject_id'], ['subjects.id'], ondelete='CASCADE'),
                    sa.PrimaryKeyConstraint('id', 'subject_id'),
                    sa.UniqueConstraint('subject_id')
    ...
    op.add_column('grades', sa.Column(
        'supervisor_mail', sa.Integer(), nullable=False))
    op.create_foreign_key(None, 'grades', 'staff', ['supervisor_mail'], [
                          'email'], ondelete='CASCADE')
    op.add_column('students', sa.Column(
        'grade_id', sa.Integer(), nullable=True))
    op.create_foreign_key(None, 'students', 'grades', [
                          'grade_id'], ['id'], ondelete='CASCADE')
