...
Revision ID: e50604f927e1
Revises: 16869e78c51a
Create Date: 2022-06-29 11:32:00.441395
...
revision = 'e50604f927e1'
down_revision = '16869e78c51a'
branch_labels = None
depends_on = None
...
def upgrade():
    ...
    op.add_column('grades', sa.Column(
        'supervisor_mail', sa.String(), nullable=False))
