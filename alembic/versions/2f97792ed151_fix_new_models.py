...
Revision ID: 2f97792ed151
Revises: 55e0a55e6707
Create Date: 2022-07-01 11:09:50.636441
...
revision = '2f97792ed151'
down_revision = '55e0a55e6707'
branch_labels = None
depends_on = None
...
def upgrade():
    ...
    op.create_table('association_class_times',
    ...
    sa.PrimaryKeyConstraint('id', 'period_id'),
    sa.UniqueConstraint('period_id')
    )
    ...
    op.create_table('association_exam_times',
    sa.Column('timetable_id', sa.Integer(), nullable=True),
    sa.Column('exam_id', sa.Integer(), nullable=True),
    sa.ForeignKeyConstraint(['exam_id'], ['exams.id'], ),
    sa.ForeignKeyConstraint(['timetable_id'], ['timetables.id'], ),
...
def downgrade():
    ...
    op.drop_table('association_exam_times')
    ...
    op.drop_table('association_class_times')
