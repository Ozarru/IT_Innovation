...
Revision ID: 50417a530740
Revises: b40b44eef4d9
Create Date: 2022-06-29 09:55:31.752493
...
revision = '50417a530740'
down_revision = 'b40b44eef4d9'
branch_labels = None
depends_on = None
...
def upgrade():
    ...
    sa.PrimaryKeyConstraint('id'),
    sa.UniqueConstraint('academic_year_name')
    )
    ...
    sa.Column('term_id', sa.Integer(), nullable=False),
    sa.Column('academic_year_name', sa.Integer(), nullable=False),
    sa.ForeignKeyConstraint(['academic_year_name'], ['academic_years.name'], ondelete='CASCADE'),
    sa.ForeignKeyConstraint(['grade_id'], ['grades.id'], ondelete='CASCADE'),
